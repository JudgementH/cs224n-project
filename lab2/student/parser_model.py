...
class ParserModel(nn.Module):
    ...
    def embedding_lookup(self, w):
        ...
        x = torch.index_select(self.embeddings, 0, w.view(-1)).view(-1, self.n_features * self.embed_size)
    ...
    def forward(self, w):
        ...
        output = self.embedding_lookup(w)
        output = F.relu(torch.matmul(output, self.embed_to_hidden_weight) + self.embed_to_hidden_bias)
